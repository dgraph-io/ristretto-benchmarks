...
//go:generate go run -tags=ignore sse_ignore.go -out sse.s -stubs stub_sse.go
//go:generate go run -tags=ignore asm2_ignore.go -out asm2.s -stubs stub_asm2.go
//go:generate go run -tags=ignore asm_ignore.go -out asm.s -stubs stub_asm.go
//go:generate go run -tags=ignore avx_ignore.go -out avx.s -stubs stub_avx.go

// Naive finds the key using the naive way
